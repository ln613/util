import { anyPass, ascend, both, cond as _cond, curry, descend, differenceWith, dissoc, find, is, isEmpty, lensPath, 
  not, pipe, prop, reduce, set as _set, sort as _sort, sortWith, splitAt, view } from 'ramda'
