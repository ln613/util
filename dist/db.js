...
exports.update = exports.search = exports.replaceList = exports.replace = exports.removeAll = exports.remove = exports.list = exports.initdocs = exports.initdata = exports.getIdName = exports.getById = exports.get = exports.count = exports.connectDB = exports.backup = exports.addToList = exports.add = void 0;
...
var search = function search(doc, query, fields) {
  ...
  return db.collection(doc).find(query || {}).project(fs)
  //.sort(s)
  .toArray();
};
